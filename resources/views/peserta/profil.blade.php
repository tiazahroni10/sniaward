                                ...
                                <div class="profile-details">
                                    ...
                                    <div class="dropdown ml-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ route('profilpeserta.edit',$data->id) }}"><li class="dropdown-item"><i class="fa fa-user-circle text-primary mr-2"></i>Edit Profil</li></a>
                                            <a href="{{ route('kontak.create') }}"><li class="dropdown-item"><i class="fa fa-address-book text-primary mr-2"></i>Kontak</li></a>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="profile-interest mb-4">
                                <h5 class="text-primary d-inline">Organisasi</h5></h5><a href="javascript:void()" class="pull-right f-s-16">Edit</a>
                                <h6><a href="post-details.html" class="text-black">PT Pertamina </a></h6>
                            </div>
                            <div class="profile-interest mb-4">
                                <h5 class="text-primary d-inline">Produk</h5></h5><a href="javascript:void()" class="pull-right f-s-16">Edit</a>
