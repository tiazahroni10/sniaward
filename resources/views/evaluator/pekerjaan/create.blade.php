                ...
                <div class="card">
                    <div class="card-body d-flex justify-content-center">
                        <div class="col-lg-8 col-md-7 order-md-1">
                            <form class="needs-validation" method="POST" action="{{ route('pekerjaan.store') }}">
                                @csrf
                                <div class="mb-3">
                                ...
                                <hr class="mb-4">
                                <button class="btn btn-warning text-white btn-sl-sm mr-2 text-white" type="submit"><span class="mr-2"></span>Simpan</button>
