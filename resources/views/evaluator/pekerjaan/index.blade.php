    ...
    <div class="container-fluid">
        <div class="page-titles ">
            <ol class="breadcrumb d-flex justify-content-between align-items-center">
                <li class="breadcrumb-item active mr-auto"><a href="javascript:void(0)">Daftar Pekerjaan</a></li>
                <li><a href="{{ route('pekerjaan.create') }}" class="btn btn-primary btn-event w-100" style="color: #ffffff">
                    <span class="align-middle"><i class="ti-plus"></i></span> Tambah Pekerjaan
                </a></li>
                            ...
                            <table class="table table-responsive-lg mb-0 table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>No</th>
                                        <th class="pl-5">Nama Instansi</th>
                                        <th class="pl-5">Jabatan</th>
                                        <th class="pl-5">Tahun Mulai</th>
                                        <th class="pl-5">Tahun Selesai</th>
                                    </tr>
                                </thead>
                                <tbody id="customers">
                                    @foreach ($dataPekerjaan as $pekerjaan)
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="py-2 pl-5 wspace-no">{{ $pekerjaan->instansi }}</a></td>
                                            <td class="py-2 pl-5 wspace-no">{{ $pekerjaan->jabatan }}</td>
                                            <td class="py-2 pl-5 wspace-no">{{ $pekerjaan->tahun_mulai }}</td>
                                            <td class="py-2 pl-5 wspace-no">{{ $pekerjaan->tahun_selesai }}</td>
                                                ...
                                                <div class="dropdown"><button class="btn btn-primary tp-btn-light sharp" type="button" data-toggle="dropdown"><span class="fs--1"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg></span></button>
                                                    <div class="dropdown-menu dropdown-menu-right border py-0">
                                                        <div class="py-2">
                                                            ...
                                                            <form action="{{ route('pekerjaan.edit', $pekerjaan->id) }}" method="GET">
                                                                @csrf 
