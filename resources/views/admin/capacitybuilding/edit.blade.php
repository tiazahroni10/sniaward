  ...
  <div class="content-body">
    <div class="container-fluid">
      <div class="page-titles">
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><a href="javascript:void(0)">Ubah Dokumen</a></li>
        </ol>
      </div>
      <!-- row -->
      <div class="row">
          ...
          <div class="card">
            <div class="card-body d-flex justify-content-center">
              <div class="col-lg-8 col-md-7 order-md-1">
                <form method="POST" action="{{ route('capacitybuilding.update', $dataCapacityBuilding->id) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="form-group">
                    <input type="text" class="form-control bg-transparent @error('nama_file') is-invalid @enderror" name="nama_file" placeholder=" Judul:"
                      value="{{ $dataCapacityBuilding->nama_file }}">
                    @error('nama_file')
