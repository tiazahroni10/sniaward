                ...
                <div class="page-titles ">
					<ol class="breadcrumb d-flex justify-content-between align-items-center">
                        ...
                        <li><a href="javascript:void()" class="btn btn-primary btn-event w-100" style="color: #ffffff">
                            <span class="align-middle"><i class="ti-plus"></i></span> Tambah Peserta
                        </a></li>
                                    ...
                                    <table class="table table-responsive-lg mb-0 table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>User Id</th>
                                                <th class="pl-5 width200">SNI Id</th>
                                                <th class="pl-5 width200">Nama Organisasi</th>
                                                <th class="pl-5 width200">Tipe Produk</th>
                                            </tr>
                                        </thead>
                                        <tbody id="customers">
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2 pl-5 wspace-no"><a
                                                        href="mailto:ricky@example.com">233344141</a></td>
                                                <td class="py-2 pl-5 wspace-no">Pertamina</td>
                                                <td class="py-2 pl-5 wspace-no">Barang</td>
